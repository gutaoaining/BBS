...
a=doc.SearchArticle(id);
if(a==null){%>
  <h1> 您找的帖子不存在</h1>
<% 
}else{
	pa=doc.SearchArticle(a.getPid());
	if(pa.getTitle()==null){
		title=a.getTitle();
	}else{
		title=pa.getTitle();
    ...
    <table summary="Buttons" border="0" cellpadding="0" cellspacing="0">
      <tbody>
        <tr>
          ...
          <td class="jive-icon-label"><a id="jive-reply-thread" href="replay.jsp?id=<%=a.getId()%>&rootId=<%=a.getRootId()%>">回复本主题</a> </td>
        </tr>
      </tbody>
    </table>
  </div>
                      ...
                      <tr id="jive-message-780144" class="jive-odd" valign="top">
                        ...
                        <td class="jive-last" width="99%"><table border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tbody>
                              <tr valign="top">
                                <td width="1%"></td>
                                <td width="97%"><span class="jive-subject"><%=title%></span> </td>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0">
                                      <tbody>
                                        <tr>
                                          ...
                                          <td class="jive-icon-label"><a href="replay.jsp?id=<%=a.getId()%>&rootId=<%=a.getRootId()%>" title="回复本主题">回复</a> </td>
                                        </tr>
                                      </tbody>
                                    </table>
                                  </div></td>
